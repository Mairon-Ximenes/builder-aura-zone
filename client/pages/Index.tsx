        ...
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              <a href="#inicio" className="text-piko-gray-dark font-manrope font-medium text-lg hover:text-piko-blue transition-colors">
                Inicio
              </a>
              <a href="#ideas" className="text-piko-gray-light font-manrope font-medium text-lg hover:text-piko-blue transition-colors">
                Ideas
              </a>
              <a href="#que-es" className="text-piko-gray-light font-manrope font-medium text-lg hover:text-piko-blue transition-colors">
                QuéEs
              </a>
              <a href="#funciones" className="text-piko-gray-light font-manrope font-medium text-lg hover:text-piko-blue transition-colors">
                Funciones
              </a>
              <a href="#usuarios" className="text-piko-gray-light font-manrope font-medium text-lg hover:text-piko-blue transition-colors">
                Usuarios
              </a>
            </div>
          </nav>
          ...
          <div className="relative order-2 lg:order-1">
            <div className="relative">
              ...
              <div className="absolute -left-8 top-16 hidden lg:block">
                <svg className="w-10 h-10 text-piko-teal" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="mb-8">
              ...
              <p className="font-manrope font-bold text-xl lg:text-2xl text-piko-blue leading-tight">
                ...
                <span className="text-piko-blue">.ai es el primer mentor de inteligencia artificial oficial del Paraguay que te ayuda a convertir ideas en negocios reales.</span>
              </p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16">
          <div className="flex items-center mb-4">
            ...
            <span className="text-piko-gray-dark font-manrope font-medium text-xl underline">Ideas</span>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <p className="font-manrope font-bold text-xl lg:text-2xl text-piko-gray-dark leading-relaxed mb-4">
                Pero no saben por dónde empezar.<br />
                No tienen un plan.<br />
                No conocen el mercado.<br />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-center lg:text-left">
            <h3 className="font-manrope font-bold text-2xl lg:text-3xl xl:text-4xl text-piko-blue leading-tight">
              Con PIKO.ai, cualquier persona — sin importar de dónde venga o cuánto sepa — puede transformar su idea en una empresa viable.
            </h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <div className="flex items-center mb-4">
              <div className="w-5 h-5 bg-piko-teal rounded-full mr-4"></div>
              <span className="text-piko-gray-dark font-manrope font-medium text-xl underline">QuéEs</span>
            </div>
            ...
            <p className="font-manrope font-bold text-2xl lg:text-3xl xl:text-4xl text-piko-blue leading-tight">
              Una inteligencia artificial entrenada para ser tu mentor de negocios personal.
            </p>
          </div>
  ...
  const features = [
    {
      ...
      image: "https://api.builder.io/api/v1/image/assets/TEMP/6d91bfe0bc3e11989960a29405c1a69cad9a4e5f?width=950"
    },
    {
      title: "Acceder a un plan de acción personalizado",
      image: "https://api.builder.io/api/v1/image/assets/TEMP/79a3814a2d1ea76e7366586a1639ea4e95e6fcae?width=954"
    },
    {
      title: "Cumplir metas semanales con seguimiento de IA",
      image: "https://api.builder.io/api/v1/image/assets/TEMP/3a1fbbfe4f3b73875c8abb839c51c65c6027499e?width=980"
    },
    {
      title: "Conectarte con oportunidades, mentores y otros emprendedores",
      image: "https://api.builder.io/api/v1/image/assets/TEMP/7a3860b93865995e01897343c4555fc630cff395?width=962"
    },
    {
      title: "Descargar materiales y herramientas",
      image: "https://api.builder.io/api/v1/image/assets/TEMP/45d56ad20afcc9f606994669436b9b813fe56a03?width=956"
    },
    {
      title: "Y lo mejor... ¡Todo 100% gratuito!",
      image: "https://api.builder.io/api/v1/image/assets/TEMP/5350bd467668bb4e6647181e04b84d7f041efd9c?width=972"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center mb-4">
            <div className="w-5 h-5 bg-piko-teal rounded-full mr-4"></div>
            <span className="text-piko-gray-dark font-manrope font-medium text-xl underline">Funciones</span>
          </div>
          
          <h2 className="font-inter text-4xl lg:text-6xl xl:text-7xl text-piko-red leading-tight mb-8">
            ¿Qué vas a poder<br />hacer com piko?
          </h2>
        </div>
        ...
        <div className="text-center">
          <p className="font-manrope font-bold text-2xl lg:text-3xl text-piko-blue">
            Acompañamiento continuo con un mentor de IA disponible las 24 horas, todos los días.
          </p>
        </div>
      </div>
    </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <div className="mb-8">
              <div className="flex items-center mb-4">
                <div className="w-5 h-5 bg-piko-teal rounded-full mr-4"></div>
                <span className="text-piko-gray-dark font-manrope font-medium text-xl underline">Usuarios</span>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
              <blockquote className="font-manrope text-xl lg:text-2xl text-piko-gray-dark leading-relaxed mb-6">
                "Yo tenía la idea de hacer jabones naturales, pero no sabía qué pasos seguir. PIKO me armó el plan, me ayudó a calcular costos y hasta encontré una proveedora en mi zona. Ahora vendo en ferias y por redes."
              </blockquote>
            ...
            <div className="space-y-4">
              ...
              <p className="font-manrope font-bold text-xl lg:text-2xl text-piko-blue leading-relaxed">
                Sos joven, madre, agricultor, estudiante, o simplemente alguien con ganas de crear algo tuyo
              </p>
    ...
    <section className="py-16 lg:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="font-inter text-4xl lg:text-6xl xl:text-7xl text-piko-green leading-tight mb-16">
          Empezá ahora. Gratis.<br />En 3 pasos simples.
        </h2>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="text-center">
            <div className="text-6xl lg:text-7xl text-piko-green font-inter font-bold mb-4">01</div>
            <img 
              src="https://api.builder.io/api/v1/image/assets/TEMP/b6281fd96965d3207d376692074ff556bd8fcefc?width=572" 
              alt="Step 1" 
          ...
          <div className="text-center">
            <div className="text-6xl lg:text-7xl text-piko-green font-inter font-bold mb-4">02</div>
            <img 
              src="https://api.builder.io/api/v1/image/assets/TEMP/18c9a6ac93c20c563a21111e72856137920c013e?width=572" 
              alt="Step 2" 
              className="w-full h-48 object-cover rounded-lg mb-4"
          ...
          <div className="text-center">
            <div className="text-6xl lg:text-7xl text-piko-green font-inter font-bold mb-4">03</div>
            <img 
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between space-y-8 lg:space-y-0">
            ...
            <div className="lg:w-1/3">
              ...
              <p className="font-manrope font-bold text-lg text-piko-gray-light leading-relaxed">
                Programa oficial del Gobierno Nacional del Paraguay, creado para impulsar el espíritu emprendedor, apoyar la economía local y generar oportunidades para todos los ciudadanos.
              </p>
            </div>
